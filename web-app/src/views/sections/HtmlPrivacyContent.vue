<template>
  ...
  <div class="pg-static">
    <div class="pg-static-banner privacy">
    ...
    <div class="section section-wrapper">
      <div class="static-body feature-text text-exsmall list-normal static-subheadings">
        <p>Effective date: January 10, 2022</p>
        <p>This Privacy Policy describes Honely, LLC&rsquo;s policies and procedures on the collection, use and disclosure of Your personal information (PI)and/or personal data (PD) when You access and use our website,
          <a
            class="static-hyperlink"
            href="https://www.honely.com"
          >
            www.honely.com
          </a> (&ldquo;SITE&rdquo;) to avail Yourself of Our Service provided through the SITE. It describes in detail Your privacy rights and how the law protects You.
        </p>
        ...
        <ul>
          <li>Account means a unique account created for You to access our Service or parts of our Service as a Registered User or Client under our
            <a
              class="static-hyperlink"
              href="https://www.honely.com/terms"
            >
          ...
          <li>Company (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Honely, LLC, a Delaware Corporation with a business address of 150 E Palmetto Park Road, Suite 800, Boca Raton, Florida 33432</li>
          ...
          <li>Country refers to: Florida, United States of America.</li>
          ...
          <li>Third-party Social Media Service refers to any website or any social network website through which a User can log in or create an account to access our Website and use our Services.</li>
          <li>Usage Data refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a webpage visit).</li>
          <li>We, Our, and Us means Honely, LLC.</li>
          <li>Website and Site refer to Honely, LLC, accessible
            <a
              class="static-hyperlink"
              href="https://www.honely.com"
            >
              https://www.honely.com
            </a>.
          </li>
          <li>You and Your means the individual accessing or using the Website, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. Under GDPR (General Data Protection Regulation), You can be referred to as the Data Subject or as the User as you are the individual using the Service.</li>
        </ul>
        <div class="static-notice-box">
          <h4>IMPORTANT NOTICE</h4>
          <p>This Site is being monitored by one or more third-party monitoring software(s), and may capture information about Your visit that will help Us improve the quality of Our services. You may opt-out from the data that SmartPiXL is collecting on Your visit through a universal consumer options page located at
            <a
              class="static-hyperlink"
        ...
        <p>For more information about the cookies we use and your choices regarding cookies, please visit our
          <a
            class="static-hyperlink"
            href="https://www.honely.com/cookiepolicy"
          >
            Cookies Policy
          </a>.
        </p>
        ...
        <p>Their Privacy Policy can be viewed at
          <a
            class="static-hyperlink"
            href="https://www.bncnationalbank/privacy policy"
          >
            www.bncnationalbank/privacy policy
          </a>
        </p>
        ...
        <ul>
          ...
          <li>Withdraw Your consent. You have the right to withdraw Your consent on using your Personal Data. If You withdraw Your consent, We may not be able to provide You with access to certain specific functionalities of Our Service.</li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <a
              class="static-hyperlink"
              href="mailto:contact@honely.com"
            >
              Contact@Honely.com
            </a>
          </li>
        ...
        <ul>
          <li><span class="static-underline">The Right to Notice.</span> You have the right to be notified which categories of Personal Data are being collected and the purposes for which the Personal Data is being used.</li>
          <li>
            <span class="static-underline">The Right to Request.</span> Under the CCPA, You have the right to request that We disclose information to You about Our collection, use, sale, disclosure for business purposes and share of personal information. Once We receive and confirm Your request, We will disclose to You:
            <ul>
          ...
          <li><span class="static-underline">The Right to Say No to the Sale of Personal Data (Opt-Out)</span>. You have the right to direct Us to not sell Your personal information. To submit an opt-out request please contact Us at
            <a
              class="static-hyperlink"
              href="mailto:info@honely.com"
            >
          ...
          <li>
            <span class="static-underline">The Right not to be Discriminated Against.</span> You have the right not to be discriminated against for exercising any of Your consumer&#39;s rights, including by:
            <ul>
        ...
        <ul>
          ...
          <li>By visiting our contact page on our website:
            <a
              class="static-hyperlink"
              href="https://www.honely.com/contact"
            >
              https://www.honely.com/contact
            </a>
          </li>
        </ul>
