...
class PostTests {
    ...
    private fun deployVerticle(vertx: Vertx, testContext: VertxTestContext) {
      vertx.deployVerticle("com.metarhythm.honely.publicapi.MainVerticle", testContext.succeeding<String> { _ -> testContext.completeNow() })
    }
    ...
    fun testCreatePostViaFile() {
        ...
        assertThat(jsonPath.getString("path")).isEqualTo("/post/2020/1/11/hello-world/")
    ...
    fun testCreatePostViaMarkdownFile() {
        ...
        assertThat(jsonPath.getString("path")).isEqualTo("/post/2020/1/12/hello-markdown/")
    ...
    fun testCreatePostWithParams() {
        ...
        assertThat(jsonPath.getString("path")).isEqualTo("/post/2021/3/18/new-post/")
    ...
    fun testUpdatePostWithParams() {
        ...
        assertThat(jsonPath.getString("path")).isEqualTo("/post/2021/3/18/new-postx/")
